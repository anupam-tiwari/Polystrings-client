  ...
  <Background color="bg-gray-100">
    <Section yPadding="py-6">
      <NavbarTwoColumns logo={<Logo xl />}>
        <li>
          <Link href="https://api.whatsapp.com/send?phone=917330914585">
            <a target="_blank">
              <svg
                width="35"
                height="35"
        ...
        <li>
          <Link href="https://www.instagram.com/polystrings.co/">
            <a target="_blank">
              <svg
                width="35"
                height="35"
      ...
      <HeroOneButton
        ...
        button={
          <Link href="https://forms.gle/EaJ55ApWe9zYG5nPA">
            <a target="_blank">
              <Button xl>Get Your First Delivery For Free</Button>
            </a>
          </Link>
        }
      />
